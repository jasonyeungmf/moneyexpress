...
*/
*}
<form name="frmpost" action="index.php?module=calculation_type&amp;view=save" method="post">
<br />
	<table align="center">
		<tr>
			<td class="details_screen">{$LANG.description}description
			<a 
				class="cluetip"
				href="#"
	...
	<div style="text-align:center;">
		<input type="hidden" name="op" value="insert_calculation_type" />
	</div>
</form>
