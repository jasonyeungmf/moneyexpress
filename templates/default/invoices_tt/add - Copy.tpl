...
<table align="center" border="0">
    ...
    <tr>
        ...
        <td>
            ...
            {else}
	            <select name="trading_type_id" id="trading_type_id">
     ...
     <!-- <td>
        ...
        <td>
			<input 
				...
				id="customer_id"
				type="text"
				value="{$smarty.post.customer_id|htmlsafe}"
				size="20"
			    AUTOCOMPLETE="OFF"
			    readonly="readonly"
        ...
        <td>
			<input 
				...
				id="account_id"
				type="text"
				value="{$smarty.post.account_id|htmlsafe}"
				size="20"
			    AUTOCOMPLETE="OFF"
    ...
    <tr>
    	...
    	<td>
			...
			{else}
				<select name="calculation_type_id" id="calculation_type_id" class="validate[required] calculation_type_change">
		...
		<td colspan="3">
			<textarea 
				...
				wrap="nowrap"
				readonly="readonly"
			>{$smarty.post.spell_number|htmlsafe}
			</textarea>
		</td>
    </tr>
