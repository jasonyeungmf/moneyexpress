...
<div id="top"><h3>Email {$invoice.index_id|htmlsafe} to Customer as PDF</h3></div>
...
<table align="center">
	...
	<td><input type="text" name="email_subject" size="50" value="{$invoice.index_id|htmlsafe} from {$biller.name|htmlsafe} is attached" /></td>
	</tr>
	<tr>
...
<br />
	<table class="buttons" align="center">
	    <tr>
	        <td>
	            <button type="submit" class="positive" name="submit" value="{$LANG.email}">
