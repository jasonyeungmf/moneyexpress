...
<form action="index.php?module=invoices&amp;view=manage&amp;having=date_between&amp;start_date={$start_date}&amp;end_date={$end_date}" method="post">
...
<br />
    <span class="welcome">
        ...
        <a href="index.php?module=invoices&amp;view=manage&amp;having=date_between&amp;start_date={$start_date}&amp;end_date={$end_date}">{$LANG.date_between}</a> |
        <a href="index.php?module=invoices&amp;view=manage&amp;having=this_year">{$LANG.this_year}</a> |
    	<a href="index.php?module=invoices&amp;view=manage&amp;having=this_month">{$LANG.this_month}</a> |
    	<a href="index.php?module=invoices&amp;view=manage&amp;having=today">{$LANG.today}</a>
       </span>
    <span class="welcome">
