...
class currencytt
{
    public static function count()
    {
         ...
         $sql = "SELECT count(id) as count FROM ".TB_PREFIX."currencys_tt WHERE domain_id = :domain_id ORDER BY id";
    ...
    public static function get_all()
    {
         ...
         $sql = "SELECT * FROM ".TB_PREFIX."currencys_tt WHERE domain_id = :domain_id and visible = 1 ORDER BY id";
         $sth  = $db->query($sql,':domain_id',$auth_session->domain_id) or die(htmlsafe(end($dbh->errorInfo())));
    ...
    public static function get($id)
    {
         ...
         $sql = "SELECT * FROM ".TB_PREFIX."currencys_tt WHERE domain_id = :domain_id and id = :id";
    ...
    public function select_all($type='', $dir, $sort, $rp, $page )
    {
        ...
        $validFields = array('id','country', 'symbol', 'currency_en', 'currency_local', 'code', 'tt_buy', 'tt_sell', 'enabled');
