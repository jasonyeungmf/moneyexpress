...
class currencycny
{
    public static function count()
    {
         ...
         $sql = "SELECT count(id) as count FROM ".TB_PREFIX."currencys_cny WHERE domain_id = :domain_id ORDER BY id";
    ...
    public static function get($id)
    {
         ...
         $sql = "SELECT * FROM ".TB_PREFIX."currencys_cny WHERE domain_id = :domain_id and id = :id";
    ...
    public function select_all($type='', $dir, $sort, $rp, $page )
    {
        ...
        $validFields = array('id','country', 'symbol', 'currency_en', 'currency_local', 'code', 'description', 'tt_buy', 'tt_sell', 'enabled');
