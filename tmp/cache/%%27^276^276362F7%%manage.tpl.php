...
" /></a></td><td class="details_screen"><?php echo $this->_tpl_vars['LANG']['inventory']; ?>
	...
	<tr>
		<td class="details_screen"><a href='index.php?module=system_defaults&amp;view=edit&amp;submit=def_trading_type'><img src="images/common/edit.png" title="<?php echo $this->_tpl_vars['LANG']['edit']; ?>
" alt="<?php echo $this->_tpl_vars['LANG']['edit']; ?>
" /></a></td><td class="details_screen"><?php echo $this->_tpl_vars['LANG']['default_trading_type']; ?>
</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['defaultTradingType']['description'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
</td>
	</tr>
        </table>
       <br /> 