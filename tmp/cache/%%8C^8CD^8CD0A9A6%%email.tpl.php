<?php /* Smarty version 2.6.18, created on 2014-02-11 01:54:33
         compiled from ../templates/default/invoices_tt/email.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'urlencode', '../templates/default/invoices_tt/email.tpl', 21, false),array('modifier', 'htmlsafe', '../templates/default/invoices_tt/email.tpl', 22, false),array('modifier', 'outhtml', '../templates/default/invoices_tt/email.tpl', 77, false),)), $this); ?>
<?php if ($_GET['stage'] == 1): ?>
...
" method="post">
<div id="top"><h3>Email <?php echo ((is_array($_tmp=$this->_tpl_vars['invoice']['index_id'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
...
" /></td>
	...
	<td><input type="text" name="email_subject" size="50" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['invoice']['index_id'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
...
<br />
	<table class="buttons" align="center">
	    <tr>
	        <td>
	            <button type="submit" class="positive" name="submit" value="<?php echo $this->_tpl_vars['LANG']['email']; ?>
">
