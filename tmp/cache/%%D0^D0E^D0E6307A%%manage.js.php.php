<?php /* Smarty version 2.6.18, created on 2013-12-11 03:11:39
         compiled from ../modules/currencys_note/manage.js.php */ ?>
...
<?php echo '\', name : \'currency_cn\', width : 10 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
<?php echo $this->_tpl_vars['LANG']['code']; ?>
<?php echo '\', name : \'code\', width : 5 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
<?php echo $this->_tpl_vars['LANG']['note_buy']; ?>
<?php echo '\', name : \'note_buy\', width : 5 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
<?php echo $this->_tpl_vars['LANG']['note_sell']; ?>
<?php echo '\', name : \'note_sell\', width : 5 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
<?php echo $this->_tpl_vars['LANG']['note_amount']; ?>
<?php echo '\', name : \'note_amount\', width : 10 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
<?php echo $this->_tpl_vars['LANG']['note_cost']; ?>
<?php echo '\', name : \'note_cost\', width : 10 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
<?php echo $this->_tpl_vars['LANG']['note_total']; ?>
<?php echo '\', name : \'note_total\', width : 10 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
