<?php /* Smarty version 2.6.18, created on 2014-01-05 01:07:23
         compiled from ../templates/default/currencys_cny/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlsafe', '../templates/default/currencys_cny/add.tpl', 19, false),array('function', 'html_options', '../templates/default/currencys_cny/add.tpl', 76, false),)), $this); ?>
...
<?php else: ?>
	...
	<?php if ($_POST['id'] != null): ?> 
		...
		You must enter a code for the currency cny</div>
		<hr />
	<?php endif; ?>
<form name="frmpost" action="index.php?module=currencys_cny&view=add" method="POST" id="frmpost" onsubmit="return checkForm(this);">
<br />
...
"  size="50" /></td>
	...
	<tr>
		...
		<td><input type="text" class="edit" name="description" value="<?php echo ((is_array($_tmp=$_POST['description'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
"  size="50" /></td>
	</tr>
	<tr>
...
">
			...
			<input type="hidden" name="op" value="insert_currency_cny" />
