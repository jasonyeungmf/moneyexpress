<?php /* Smarty version 2.6.18, created on 2014-01-05 00:18:45
         compiled from ../modules/currencys_tt_cny/manage.js.php */ ?>
...
<?php echo '\', name : \'description\', width : 5 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
...
<?php echo '\', name : \'enabled\', width : 5 * percentage_width, sortable : true, align: \'left\'}
			...
			(
			{
			url: \'index.php?module=currencys_tt_cny&view=xml\',
			dataType: \'xml\',
			colModel : col_model,
			searchitems : [
				{display: \''; ?>
