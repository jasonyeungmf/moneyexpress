<?php /* Smarty version 2.6.18, created on 2014-01-05 01:00:40
         compiled from ../modules/currencys_cny/manage.js.php */ ?>
...
<?php echo '\', name : \'description\', width : 10 * percentage_width, sortable : true, align: \'left\'},
				    {display: \''; ?>
...
<?php echo '\', name : \'enabled\', width : 5 * percentage_width, sortable : true, align: \'left\'}
			...
			(
			{
			url: \'index.php?module=currencys_cny&view=xml\',
			dataType: \'xml\',
			colModel : col_model,
			searchitems : [
				{display: \''; ?>
