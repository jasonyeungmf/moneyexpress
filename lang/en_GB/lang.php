...
$LANG['city'] = "City";//1
$LANG['confirm_delete'] = "Are you sure want to delete?";//1
...
$LANG['help_tax_rate_sign'] = "A tax can be either a percentage based (ie. Sales Tax 10%) or a flat money values (ie. $10 or £20).or charge per line item.<br /><br />The $ in the drop down only indicates that this will be a flat money rate and it doesnt indicate the currency symbol. The 'invoice preference' that you use dictates what the currency symbol will be in your invoices.";//1
...
$LANG['name_attn'] = "Name/Attn.";//1
$LANG['mobile_phone_fax'] = "Mobile/Phone/Fax";//1
$LANG['id_no'] = "ID No.";//1
$LANG['id_document'] = "ID document";//1
$LANG['import_from_excel'] = "Import from excel";//1
$LANG['website'] = "Website";//1
$LANG['street_address'] = "Street address";//1
$LANG['street_address2'] = "Street address 2";//1
$LANG['customer_no'] = "Customer No.";//1
$LANG['update_customers_success'] = "Successfully updated,<br />you will be redirected to the customers page";//1
$LANG['update_customers_failure'] = "Something went wrong, Please try updating the customers again";//1
$LANG['help_id_document'] = "Input a file name of image as folder '/images/id_document/*.*',ie. id_1.jpg";//1
$LANG['customer_total'] = "Customer Total";//1

// Account
$LANG['account'] = "Account";//1
$LANG['accounts'] = "Accounts";//1
$LANG['account_add'] = "Add New Account";//1
$LANG['no_accounts'] = "There have been no accounts created.  Click the 'Add New Account' buttom above to create one";//1
$LANG['no_province'] = "There have been no province created.";//1
$LANG['serial_no'] = "Serial No.";//1
$LANG['payee'] = "Payee";//1
$LANG['bank'] = "Bank";//1
$LANG['account_no'] = "Account No.";//1
$LANG['save_account'] = "Save Account";//1
$LANG['save_account_failure'] = "Something went wrong, please try saving the account again<br />";//1
$LANG['save_account_success'] = "Account successfully saved, <br /> you will be redirected to the Manage Accounts page";//1
$LANG['insert_account'] = "Insert Account";//1
...
$LANG['sell'] = "Sell";//1
$LANG['buy'] = "Buy";//1
$LANG['note_buy'] = "Note Buy";//1
$LANG['note_sell'] = "Note Sell";//1
$LANG['note_amount'] = "Amount";//1
$LANG['note_cost'] = "Note Cost";//1
$LANG['note_total'] = "Total";//1
$LANG['notes_rate_update'] = "Notes Rate Update";//1
$LANG['currency_note'] = "Currency Note";//1
$LANG['note'] = "Note";//1
$LANG['currency_note_add'] = "Add New Currency";//1
$LANG['no_currencys_note'] = "There have been no currencys created. Click the 'Add New Currency' buttom above to create one";//1
$LANG['save_currency_note_success'] = "Successfully saved, <br /> you will be redirected to the note page";//1
$LANG['save_currency_note_failure'] = "Something went wrong, please try saving again";//1
$LANG['update_currency_note_rate_success'] = "Successfully updated,<br />you will be redirected to the note page";//1
...
$LANG['amount'] = "Amount";//1
$LANG['tt_rate_update'] = "T/T Rate Update";//1
$LANG['currency_tt'] = "Currency T/T";//1
$LANG['tt'] = "T/T";//1
$LANG['currency_tt_add'] = "Add New Currency";//1
$LANG['no_currencys_tt'] = "There have been no currency created. Click the 'Add New Currency' buttom above to create one";//1
$LANG['save_currency_tt_success'] = "Successfully saved, <br /> you will be redirected to the T/T page";//1
$LANG['save_currency_tt_failure'] = "Something went wrong, please try saving again";//1
...
$LANG['no_currencys_cny'] = "There have been no currency created. Click the 'Add New Currency' buttom above to create one";//1
$LANG['save_currency_cny_success'] = "Successfully saved, <br /> you will be redirected to the CNY page";//1
$LANG['save_currency_cny_failure'] = "Something went wrong, please try saving again";//1
$LANG['update_currency_cny_rate_success'] = "Successfully updated,<br /> you will be redirected to the CNY page";//1
$LANG['update_currency_cny_rate_failure'] = "Something went wrong, Please try updating the CNY rate again";//1

// Note invoice
$LANG['attention'] = "Attention";//1
$LANG['invoice'] = "Invoice";//1
$LANG['end_date'] = "End Date";//1
...
$LANG['profit'] = "Profit";//1
$LANG['product'] = "Product";//1
$LANG['currency_detail'] = "Currency Detail";//1
$LANG['rate'] = "Rate";//1
$LANG['start_date'] = "Start Date";//1
$LANG['search'] = "Search";//1
$LANG['subtotal'] = "Subtotal";//1
$LANG['staff'] = "Staff";//1
$LANG['this_year'] = "This Year";//1
$LANG['this_month'] = "This Month";//1
$LANG['today'] = "Today";//1
$LANG['total'] = "Total";//1
...
$LANG['trading_types'] = "Trading Types";//1
$LANG['trading_type'] = "Trading Type";//1
$LANG['trading_type_id'] = "Trading Type ID";//1
$LANG['no_trading_types'] = "No Trading Types";//1
$LANG['trading_type_description'] = "Trading type description";//1
$LANG['add_new_trading_type'] = "Add New Trading Type";//1
$LANG['save_trading_type_failure'] = "Something went wrong, please try saving the trading type again";//1
$LANG['save_trading_type_success'] = "Trading Type successfully saved, <br /> you will be redirected back to the Manage Trading Types";//1
$LANG['default_trading_type'] = "Default Trading Type";//1

// T/T Invoice
$LANG['help_insert_user_text'] = "To select no logo please select '_default_blank_logo.png' from the list.<br /><br />To add additional logos into Simple Invoices, copy the logo file into the logo directory in the Simple Invoices folder.";//1
$LANG['help_quantity_types'] = "Make sure quantity for first";//1
$LANG['help_payable_amount_types'] = "Make sure payable amount for first";//1
$LANG['internal_id'] = "Internal ID";//1
$LANG['charge'] = "Charge";//1
$LANG['payable_amount'] = "Payable Amount";//1
$LANG['customer_name'] = "Customer Name";//1
$LANG['customer_detail'] = "Customer Detail";//1
$LANG['customer_detail_2'] = "Customer Detail (2)";//1
$LANG['account_detail'] = "Account Detail";//1
$LANG['bank'] = "Bank";//1
$LANG['spell_number'] = "Spell Number";//1
$LANG['quantity_style'] = "Quantity Style";//1
$LANG['payable_amount_style'] = "Payable Amount Style";//1
$LANG['save_invoice_tt_success'] = "Successfully saved, <br /> you will be redirected to the T/T Invoices page";//1
$LANG['save_invoice_tt_failure'] = "Something went wrong, please try saving again";//1
$LANG['submit'] = "Submit";//1
$LANG['export_jpg'] = "Export to JPG";//1
$LANG['export_jpg_tooltip'] = "to a jpg as";//1

// Trading Types
$LANG['setup_add_currency_for_tt'] = "Add some currencies for T/T, click ";//1
$LANG['add_new_currency_for_tt'] = "Add New Currency For T/T";//1
$LANG['setup_add_account'] = "Add some accounts, click ";//1
$LANG['add_new_account'] = "Add New Account";//1
$LANG['setup_add_trading_type'] = "Add some trading types, click ";//1
$LANG['add_new_trading_type'] = "Add New Trading Type";//1

// Payment type
$LANG['payment_types'] = "Payment Types";//1
$LANG['no_payment_types'] = "There have been no payment types created.  Click the 'Add New payment type' buttom above to create one";//1

// Calculation Types
$LANG['calculation_type'] = "Calculation Type";//1
$LANG['calculation_types'] = "Calculation Types";//1
$LANG['add_new_calculation_type'] = "Add New Calculation Type";//1
$LANG['no_calculation_types'] = "No Calculation Types";//1
$LANG['calculation_type_description'] = "Calculation type description";//1
$LANG['save_calculation_type_failure'] = "Something went wrong, please try saving the calculation type again";//1
$LANG['save_calculation_type_success'] = "Calculation Type successfully saved, <br /> you will be redirected back to the Manage Calculation Types";//1

//auth
$LANG['money_express_system'] = "Money Express System";//1
